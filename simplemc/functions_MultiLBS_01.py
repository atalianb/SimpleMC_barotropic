...
def shooting01_V(func,u,x0,x,xf,step,phi0,phi1,h=0.01):
    def IC_V(u):
        return np.array([phi0,0.,u[0],0.,u[1],0.,phi1,0.,u[2],0.])
...
#####
def Vc_(r,m_a,eps,phi0,phi1):
    X,Y,root_f=shooting01_V(rhs,u_012_V,x0_0v1,x0_0,xf_0v1,step_0,phi0,phi1)
...
def Vc_inter(r,m_a,eps,phi0,phi1):
    Vc = Vc_(r,m_a,eps,phi0,phi1)
